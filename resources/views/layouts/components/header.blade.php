...
<div class="flex items-center gap-4">
    @if (Auth::user() == null)
        <a href="#" class="btn font-medium hover:bg-blue-700 py-2" aria-current="page">Se connecter</a>
        <a href="#" class="btn font-medium hover:bg-blue-700 py-2" aria-current="page">S'inscrire</a>
    @else
        <a href="#" class="btn font-medium hover:bg-blue-700 py-2" aria-current="page">Se déconnecter</a>
    @endif
